<?php
  ...
  $sql="SELECT mid,SUM(qty) as Qty FROM `grn` WHERE approvedBy is not null GROUP BY mid";
  ...
  $sql2="SELECT item_no,SUM(qty) AS Qty from stocks WHERE type='material' AND dept='store' GROUP BY item_no;";
  ...
  $sql3="SELECT item_no,SUM(qty) AS Qty FROM `gtn` WHERE dept='store' AND type='out' and item_type='material' and approved_by IS NOT null GROUP BY item_no";
  ...
  $sql4="SELECT item_no,SUM(qty) AS Qty FROM `gtn` WHERE dept='pFloor' AND type='in' and item_type='material' and approved_by IS NOT null GROUP BY item_no";
...
$sql5="SELECT item_no,SUM(qty) AS Qty FROM `gtn` WHERE dept='pFloor' AND type='out' and item_type='finished product' and approved_by IS NOT null GROUP BY item_no";
...
$sql6="SELECT item_no,SUM(qty) AS Qty FROM `gtn` WHERE dept='fGoods' AND type='in' and item_type='finished product' and approved_by IS NOT null GROUP BY item_no";
...
$sql7="SELECT item_no,SUM(qty) AS Qty from stocks WHERE type='finished product' AND dept='fGoods' GROUP BY item_no;";
...
$sql8="SELECT item_no,SUM(qty) AS Qty from invoice WHERE approved_by IS NOT null GROUP BY item_no;";
...
$sql10="SELECT item_no,SUM(qty) AS Qty from stocks WHERE type='material' AND dept='pFloor' GROUP BY item_no;";
...
$sql11="SELECT item_no,SUM(qty) AS Qty from stocks WHERE type='finished product' AND dept='pFloor' GROUP BY item_no;";
