  ...
  <body>
    ...
    <section class="section-manage">
        ...
        <div class="col span-6-of-7">
            <form action="../PHPScripts/manageBOMScript.php" method="post">
      <table>
        <thead>
          <th>BOM ID</th><th>State</th><th class="bt chk">&nbsp;</th>
        </thead>
        <?php
          ...
          while($row=mysqli_fetch_assoc( $rowSQL )){
            echo "
              <tr>
                <td>".$row['bom_id']."</td>
                <td>".$row['state']."</td>
                <td class='chk'><input type='submit' value='view' name='".$row['bom_id']."'></td>
              </tr>
            ";
          }
        ?>
